...
export async function PATCH(req: Request) {
	...
	if (typeof body.primaryColor === "string")
		patch.primaryColor = body.primaryColor || null;
	if (typeof body.accentColor === "string")
		patch.accentColor = body.accentColor || null;
	if (typeof body.fontFamily === "string")
		patch.fontFamily = body.fontFamily || null;
	if (typeof body.channelName === "string")
		patch.channelName = body.channelName || null;
	if (typeof body.hostName === "string")
		patch.hostName = body.hostName || null;
