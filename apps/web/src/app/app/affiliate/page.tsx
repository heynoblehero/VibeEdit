		...
		return (
			<main className="mx-auto max-w-2xl p-8">
				...
				<p className="text-sm text-[var(--color-fg-muted)]">
					Payouts go live once Stripe Connect is integrated. Want to be
					notified the day it opens?{" "}
					<a
	...
	return (
		<main className="mx-auto max-w-3xl p-4 sm:p-8">
			...
			<p className="mb-8 max-w-2xl text-[var(--color-fg-muted)]">
				Share VibeEdit Video. Earn <strong>30% recurring</strong> on every
				paid signup that comes from your link, for as long as they're
				subscribed.
			</p>
