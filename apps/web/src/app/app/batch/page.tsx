    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      <header className="mb-8">
        ...
        <p className="mt-2 max-w-xl text-sm text-[var(--color-fg-muted)]">
          Write one brief. We fork it into 2–5 differently-styled projects (punchy, cinematic,
          maximalist, minimal, alt palette). Open each, approve the plan, render the winners.
        </p>
      </header>
          ...
          {created.map((project) => (
            ...
            >
              <div className="mb-1 flex items-center justify-between">
                ...
                <span className="text-xs text-[var(--color-fg-muted)]">Open →</span>
              </div>
