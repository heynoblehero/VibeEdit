...
export default function StockPage() {
	...
	const [kind, setKind] = useState<"all" | "sfx" | "broll" | "character">(
		"all",
	);
	...
	return (
		<main className="mx-auto max-w-6xl p-4 sm:p-8">
			...
			<p className="mb-6 max-w-2xl text-[var(--color-fg-muted)]">
				CC0 SFX, royalty-free B-roll, and self-created host illustrations the
				agent can pull from automatically. Just say "use the dramatic riser"
				or "pull a glitch overlay" in chat.
			</p>
	...
	return (
		<div className="overflow-hidden rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)]">
			...
			<div className="p-3">
				...
				<div className="mb-2 font-mono text-[10px] text-[var(--color-fg-muted)]">
					{asset.slug}
				</div>
