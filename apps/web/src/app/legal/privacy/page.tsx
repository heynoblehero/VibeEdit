export default function Privacy() {
	return (
		<>
			...
			<p>
				Data is stored in our cloud infrastructure. Compositions, renders,
				and assets are stored on encrypted disk and retained until you delete
			...
			<p>
				Each handles your data under their own privacy terms. We share only
			...
			<p>
				...
				. Account deletion is irreversible and removes your compositions,
				renders, and chat history.
			</p>
