      ...
      <section id="faq" className="mx-auto max-w-3xl px-4 py-20 sm:px-6 sm:py-28">
        ...
        <div className="space-y-2">
          ...
          <Faq
            ...
            a="They generate raw pixels you can't edit. VibeEdit edits real footage and builds compositions that render deterministically — same prompt, same MP4, every time. And you can refine anything just by chatting."
          />
          <Faq
      ...
      <section className="relative border-t border-[var(--color-border)] overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-24 text-center sm:px-6 sm:py-32">
          ...
          <p className="mx-auto mt-5 max-w-md text-[var(--color-fg-muted)]">
            The easiest way to make videos. No timeline, no tools to learn — just talk, and the AI
            builds it.
          </p>
          <Link
            href="/app/signup"
