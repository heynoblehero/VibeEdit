...
// ---------------------------------------------------------------------------
// Caption cue data. Produced by build_captions_from_words / generate_captions
// and rendered as a native HTML/CSS/GSAP overlay by the add_text_overlay tool
// (see lib/ai/captions). The old libass ASS burn path was removed — captions are
// no longer baked into the footage by ffmpeg.
// ---------------------------------------------------------------------------
...
export interface CaptionCue {
  ...
  style?: CaptionStyle; // optional per-cue style hint (see add_text_overlay presets)
}
