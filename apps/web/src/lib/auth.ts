...
if (process.env.NODE_ENV === "production" && !isBuildPhase && !process.env.BETTER_AUTH_SECRET) {
  throw new Error("BETTER_AUTH_SECRET must be set in production — sessions would be forgeable.");
}
