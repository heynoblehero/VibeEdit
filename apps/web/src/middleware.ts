...
const RULES: Record<string, Rule> = {
  ...
  // NOTE: /api/tools is deliberately NOT here. Those routes take a multipart
  // upload, and running Edge middleware in front of a multipart POST breaks the
  // Node route's request.formData() in Next 15 ("expected multipart form data").
  // The burst limit for tool uploads is enforced IN the route instead, on top
  // of its own per-day quota.
