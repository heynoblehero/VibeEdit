...
export const SceneRenderer: React.FC<SceneRendererProps> = ({
  ...
  return (
    ...
    <GradientBg
      ...
      borderRadius={s.background.borderRadius}
      ...
      brightness={s.background.brightness}
      contrast={s.background.contrast}
      saturation={s.background.saturation}
      temperature={s.background.temperature}
      videoUrl={s.background.videoUrl}
      videoStartSec={s.background.videoStartSec}
      videoMuted={s.background.videoMuted}
      videoEndSec={s.background.videoEndSec}
      videoPlaybackRate={s.background.videoPlaybackRate}
      ...
      imageCrop={s.background.imageCrop}
      ...
      videoCrop={s.background.videoCrop}
    >
